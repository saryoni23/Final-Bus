                        ...
                        <div class="card card-warning">
                            ...
                            <form action="/orders" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="transportasi_id" class="col-sm-2 col-form-label">transportasi :</label>
                                        <div class="col-sm-5">
                                            <select class="form-control" id="transportasi" name="transportasi_id"
                                                required>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group">
                                                <select name="type_id" class="form-control" id="transportasi_class" required>
                                                    @if (old('type_id'))
                                    ...
                                    <div class="form-group row">
                                        <div class="mb-2 col-lg-2 col-sm-12 align-items-start">
