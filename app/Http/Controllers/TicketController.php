...
class TicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validateSameTicket = Ticket::where('transportasi_id', $validatedData['transportasi_id'])->where('type_id', $validatedData['type_id'])->where('track_id',  $validatedData['track_id'])->first();
        ...
        $currentTicket = Ticket::where('transportasi_id', $validatedData['transportasi_id'])->where('type_id', $validatedData['type_id'])->where('track_id',  $validatedData['track_id'])->first()->id;

        $validatedPrice['ticket_id'] = $currentTicket;
        $validatedPrice['price'] = $validatedData['price'];
        $validatedPrice['kode_bus'] = $validatedData['kode_bus'];
